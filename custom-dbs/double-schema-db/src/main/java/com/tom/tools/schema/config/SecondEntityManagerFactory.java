...
@Configuration
@EnableJpaRepositories(entityManagerFactoryRef = "ds2EntityManagerFactory", transactionManagerRef = "ds2TransactionManager", basePackages = "com.tom.tools.schema.ds2")
...
public class SecondEntityManagerFactory {
	...
	LocalContainerEntityManagerFactoryBean ds2EntityManagerFactory(EntityManagerFactoryBuilder builder,
			@Qualifier("dataSourceAuthorsSchema") DataSource dataSource) {
	...
	protected String[] packagesToScan() {
		return new String[] { "com.tom.tools.schema.ds2" };
	}
