...
public class MailController {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<MailResponse> searchMailById(@PathVariable(value = "id") UUID mailId) {
		var response = mailService.searchMailById(mailId);
		return ResponseEntity.status(HttpStatus.OK).body(response);
	}
	...
	public ResponseEntity<Boolean> defineMasterEmail(@RequestBody MasterMailRequest request) {
