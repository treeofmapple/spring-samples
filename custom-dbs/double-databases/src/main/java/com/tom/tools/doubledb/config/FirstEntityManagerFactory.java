...
@Configuration
@EnableJpaRepositories(entityManagerFactoryRef = "ds1EntityManagerFactory", transactionManagerRef = "ds1TransactionManager", basePackages = "com.tom.tools.doubledb.ds1")
...
public class FirstEntityManagerFactory {
	...
	protected String[] packagesToScan() {
		return new String[] { "com.tom.tools.doubledb.ds1" };
	}
